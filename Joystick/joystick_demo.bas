OpenWindow("Joystick Test",640,500,0,1)
m_canvas = OpenCanvas(640,500,0,0,640,500,0)
m_font = LoadFont("FreeMono.ttf",16)
SetFont(m_font)
...
while true
	...
	for i = 0 to 14
		if button[i] then
			SetColor(rgb(255,0,0))
			DrawText("Button " + str$(i) + " was pressed", 10, i * 15 + 260)
		else
			SetColor(rgb(255,255,255))
			DrawText("Button " + str$(i) + " not pressed", 10, i * 15+260)
		end if
		SetColor(rgb(255,255,255))
		DrawText("Axis(" + str$(i) + ") = " + str$(axis[i]), 280, i * 15+260)
		DrawText("Hat(" + str$(i) + ") = " + hat$[i], 450, i * 15+260)
	next
