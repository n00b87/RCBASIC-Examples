...
Function setup()
    WindowOpen(0, "Raycast", WINDOWPOS_CENTERED, WINDOWPOS_CENTERED, WINDOW_WIDTH, WINDOW_HEIGHT, WINDOW_VISIBLE, 1)
    CanvasOpen(0, WINDOW_WIDTH, WINDOW_HEIGHT, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, 1)
    CanvasOpen(BUFFER_BACK, WINDOW_WIDTH, WINDOW_HEIGHT, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, 0)
